...
include('newdb.php');
  ...
  $sql = "select SUM(`jhkpshl`),SUM(`fyshl`) from `zyff` where `yfmch`='".$yhgldw."' and `zyffzht` IS NULL and `fyrq`>='$kshnyr' and `fyrq`<'$jshnyr'";
...
$pdf->Ln();//
$pdf->Cell(190, 24, iconv("UTF-8", "gbk", "空瓶回收记录表"), 0, 0, 'C');

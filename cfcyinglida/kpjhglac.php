...
while ( $yfidmchRecord = mysql_fetch_array ( $yfidmchQuery_ID ) ) {
	$yfidmch [] = $yfidmchRecord [0];
}
...
$numquery = "select SUM(jhkpshl),SUM(`fyshl`) from `zyff` WHERE `jhkpshl`>'0' and `kpzht`='1' and `yfmch`='$yhgldw'";

...
<link href="css/AnniuCaidan.css" rel="Stylesheet" type="text/css" />
...
<script type="text/javascript" src="js/TJAutoComplete.js"></script>
<script type="text/javascript" src="js/RenyuanXuanzeqi.js"></script>
<script type="text/javascript" src="js/jquery.blockUI.js"></script>
<script type="text/javascript" src="js/jquery.form.js"></script>
<script type="text/javascript" src="js/jquery.bgiframe.js"></script>
<script type="text/javascript" src="js/AnniuCaidan.js"></script>
<script type="text/javascript" src="js/ShenfenzhengYuedu.js"></script>
<script type="text/javascript" src="js/SelectDate.js"></script>
<script type="text/javascript" src="js/main.js"></script>
<script type="text/javascript" src="js/Hangjialiang.js"></script>
<script type="text/javascript" src="js/jquery.placeholder.min.js"></script>
<script type="text/javascript" src="js/Initplacehoder.js"></script>
<script type="text/javascript" src="js/DiquXuanzeqi.js"></script>
<script type="text/javascript" src="js/json2.js"></script>
<script type="text/javascript" src="js/FuheBianjiqi.js"></script>
<script type="text/javascript" src="js/WangshenFuheBianjiqi.js"></script>
<script type="text/javascript" src="js/ChengshiYiyuanYishengXuanzeqi.js"></script>
</head>
<body>
    <div id="headerUser" class="noPrint">
        <div id="userAction">
            <table width="100%">
                <tr>
                    <td align="left">
<table>
    <tr>
        <td>欢迎您，<b><?php echo $_SESSION[yhname];?></b>&nbsp;</td>
        <td>
        <dl id="qihuanshenfen" class="AnniuCaidan" style="float: left;" onclick="ClickAnniuCaidan(this);">
          <dt><a href="javascript:void();"><nobr>快速操作菜单▽&nbsp;</nobr></a></dt>
          <dd>
            <ul>
        ...
        <td>
            ...
            <a href="xgmm.php">修改密码</a>
                    ...
                    <td align="right">
                        &nbsp;<a href="manager.php">首页</a>&nbsp;<a href="shqglxzshq.php">新增申请</a>&nbsp;<a href="shqgl.php">申请管理</a>&nbsp;<a href="xzshhdch.php">社会调查管理</a>
    ...
    <div id="headerCon" class="noPrint">
        <div id="header">
            
<a href="manager.php" title="" id="lnk_header_title1">
        <img style="border-radius:4px;" alt="" src="images/logoRuxianai.jpg" /></a>
</div>
    </div>
    <div id="content">
        <div id="con">
    ...
    <div class="form">
        ...
        <fieldset>
            <legend>申请信息</legend>
            <div>
                <span class="label">姓名：</span><input class="input addInput" id="Xingming" name="Xingming" type="text" value="" /><font color="red">*</font>
                <span class="label">证件类型：</span><select id="zhjlx" name="zhjlx">
<option selected="selected" value="身份证">身份证</option>
<option value="军官证">军官证</option>
</select> <input class="input addInput" id="ShenfenHaoma" name="ShenfenHaoma" type="text" value="" /><font color="red">*</font><span style="color:red;" id="shfzhcztx" name="shfzhcztx"></span>
            </div>
            <div>
                <span class="label">申请病种：</span><select id="ShenqingBingzhongq" name="ShenqingBingzhongq">
<option selected="selected" value="肺癌">肺癌</option>
</select><font color="red">*</font>
<span class="label">出生日期：</span><input class="input addInput" id="hzhchshrq"  name="hzhchshrq"  readonly type="text" value="" /><font color="red">*</font></div>
<div><span class="label">性别：</span><select id="hzhxingbie" name="hzhxingbie"><option value="">--请选择--</option>
<option value="男">男</option>
<option value="女">女</option>
</select><font color="red">*</font></div>
            <div>
                <span class="label">申请的医院/医生：</span><select id="ShenqingYishengId" name="ShenqingYishengId" style="width: 500px;"  onchange="qzyzh()">
    <option value=""></option>
<?php        
...
?>  
            ...
            <div>
                <span class="label">患者通讯住址：</span><select id="s_province" name="sheng"></select>&nbsp;&nbsp;
    ...
    <script type="text/javascript">_init_area();</script>
            ...
            <div>
                <span class="label">街道地址：</span><input class="input addInput" id="Zhuzhi" name="Zhuzhi" style="width:50%" type="text" value="" />*
            </div>
            <div>
<script>  
...
if( v.length!=11||!v.match(a) ){  
  ...
  return false;
                ...
                <span class="label">手机：</span><input class="input addInput" id="shouji" name="shouji" type="text" value=""  onblur="yzshj(this.value)"/>*
                <span class="label">联系电话1：</span><input class="input addInput" id="dianhua2" name="dianhua2" type="text" value="" />
                <span class="label">联系电话2：</span><input class="input addInput" id="dianhua3" name="dianhua3" type="text" value="" />
            </div>
            <!--div>
            ...
            <div>
                <span class="label">户籍类型：</span><select name="hzhhj" id="hzhhj">
						  <option value="非农业户口">非农业户口</option>
						  <option value="农业户口">农业户口</option>
						</select>*
                <span class="label">家庭人口：</span><select id="JiatingRenkou" name="JiatingRenkou"><option value="1">1</option>
...
<option value="19">19</option>
                ...
                家庭年收入：<input class="input addInput" id="NianShouru" name="NianShouru" style="width:100px" type="text" value="0" />元*
                <span style="width: 180px; color: Green;" id="span_pinjunshouru"></span>
            </div>
            <div>
                <span class="label">参保类型：</span><select name="CanBaoLeiXing" id="CanBaoLeiXing" style="width:100px" onchange="cblxxz()">
...
<div  id="cbdqxz" Style="display:none;">
                <span class="label">参保地区：</span><select id="cbdqs_province" name="cbdqsheng"></select>&nbsp;&nbsp;
    <select id="cbdqs_city" name="cbdqshi" ></select>*
    ...
    <script type="text/javascript">_init_areaa();</script>
            ...
            <div>
                <span class="label">用药剂量：</span><select id="YongYaoJiLiang" name="YongYaoJiLiang"><option value="250mg*60粒/瓶">250mg*60粒/瓶</option>
<option value="200mg*60粒/瓶">200mg*60粒/瓶</option>
</select>*
                <span class="label">用法：</span><select id="YongYaoFangFao" name="YongYaoFangFao" onchange="showText()"><option value="2粒/天*30天">2粒/天*30天</option>
...
<span class="label" >其他说明：</span><input class="input addInput" id="qtshm" name="qtshm" style="width:300px;" type="text" value="" /></div>
            ...
            <div>
                ...
                <span class="label" style="width: 160px">首次申请材料登记日期：</span><input class="input addInput" id="djrq" name="djrq" type="text" value="<?php echo date('Y-m-d');?>"  readonly />*
                <!--div id="shcyyrqqb">
                ...
                <div >
                <span class="label" style="width: 180px">预估首次赠药用药日期：</span><input class="input addInput" id="ygShouciYongyaoRiqi2" readonly name="ygShouciYongyaoRiqi" type="text" value="" />
                </div>
            </div>
        </fieldset>
        <fieldset>
            ...
            <table id="tb_ZhixiQinshus" class="table">
                ...
                <tr id="tr_action">
                    <td style="text-align: center">
                        <input type="text" id="txtXingming" name="txtXingming" />
                    </td>
                    <td style="text-align: center">
                        <input type="text" id="txtShenfenzheng" name="txtShenfenzheng" />
                    </td>
                    <td style="text-align: center">
                        <input type="text" id="txtjgzh" name="txtjgzh" />
                    </td>
                    <td style="text-align: center">
                        <select Style="width:130px" id="txtGuanxi" name="txtGuanxi"><option selected="selected" value="父亲">父亲</option>
...
<option value="其他关系">其他关系</option>
                    ...
                    <td style="text-align: center">
                        <input type="text" id="txtLianXiFangShi" name="txtLianXiFangShi" />
                    </td>
                    <td style="text-align: center">
                        <input type="button" id="btnAdd" value="添加" class="lgSub" />
                    </td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
            ...
            <div>
                <span class="label" style="width: 180px;">临床诊断：</span><select id="lchzhd" name="lchzhd" onchange="showpgText()"  style="width: 500px;">
...
<span class="label"  style="width: 180px;">其他说明：</span><input class="input addInput" id="qtlchzhd" name="qtlchzhd" style="width:300px;" type="text" value="" /></div>
            </div>
            <div>
                <span class="label" style="width: 180px;">诊断日期：</span><input class="input addInput" id="zhdrq"  name="zhdrq"  readonly type="text" value="" />*
                <span class="label" style="width: 180px;">肿瘤病理类型：</span><select id="zhlbl" name="zhlbl"onchange="showlxText()"><option selected="selected"  value="">--请选择--</option>
...
<span class="label"  style="width: 180px;">其他说明：</span><input class="input addInput" id="qtzhlbl" name="qtzhlbl" style="width:300px;" type="text" value="" /></div>
</div>
<div><span class="label" style="width: 180px;">分期：</span><select id="fq" name="fq" onchange="showfqText()">
<option selected="selected" value="">--请选择--</option>
...
<span class="label"  style="width: 180px;">其他说明：</span><input class="input addInput" id="qtfq" name="qtfq" style="width:300px;" type="text" value="" /></div>
</div>
            <div>
                <span class="label" style="width: 180px;">ALK检测：</span><select id="alkjc" name="alkjc" style="width: 500px;">
<option selected="selected" value="">--请选择--</option>
    ...
    <option value="阴性">阴性</option>  
            ...
            <div>
                <span class="label" style="width: 180px;">ALK诊断方法：</span><select id="alkzhdff" name="alkzhdff" style="width: 500px;">
<option selected="selected" value="">--请选择--</option>
    ...
    <option value="间变性淋巴瘤激酶(ALK)阳性的转移性的非小细胞肺癌(NSCLC)">间变性淋巴瘤激酶(ALK)阳性的转移性的非小细胞肺癌(NSCLC)</option>
            ...
            <div>
                <span class="label" style="width: 180px;">赛可瑞开始治疗时间：</span><input class="input addInput" id="skrkshzhlshj"  name="skrkshzhlshj"  readonly type="text" value="" />*
                <span class="label" style="width: 180px;">赛可瑞治疗疗程：</span><input class="input addInput" id="skrzhllch" name="skrzhllch" type="text" value=""/> 月*
            </div>
            <div>
                <span class="label" style="width: 180px;">赛可瑞治疗效果(RECIST 标准)评估：</span><select id="skrzhlxgpg" name="skrzhlxgpg" style="width: 500px;">
<option selected="selected" value="">--请选择--</option>
    ...
    <option value="PD">PD</option>  
            ...
            <div>
                <span class="label" style="width: 180px;">出现无法耐受的副作用：</span><select id="chxwfnshdfzy" name="chxwfnshdfzy" style="width: 500px;">
<option selected="selected" value="">--请选择--</option>
    <option value="未用药">未用药</option>
    ...
    <option value="否">否</option>  
            ...
            <div>
                <span class="label"  style="width: 180px;">是否应该继续赛可瑞治疗：</span><select id="shfygjxskrzhl" name="shfygjxskrzhl" style="width: 500px;">
<option selected="selected" value="">--请选择--</option>
    <option value="是">是</option>
    <option value="否">否</option>  
</select>

...
<div class="main">
    <div class="insmain">
        <div class="thislink">当前位置：<a href="kfkcpdgl.php">库存盘点</a></div>
        <div class="inwrap flt top">
            ...
            <div class="incontact w955 flt">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        <td>
                            ...
                            <div class="insinsins"><span><input class="grd-white" type="text" id="KaishiRiqi"
                                                                name="KaishiRiqi" readonly="readonly"
                                                                placeholder="请输入开始日期" size="12" value=""/> - <input
                                        class="grd-white" type="text" id="JiezhiRiqi" name="JiezhiRiqi"
                                        readonly="readonly" placeholder="请输入结束日期" size="12" value=""/>  <input
                                        type="button" value="按盘点日期过滤" onclick="guolv();" class="uusub"/></span></div>
                        </td>
                    </tr>
                </table>
                <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#cdcdcd">
                    ...
                    <tr style="color:#1f4248; font-weight:bold; height:30px;">
                        <td width="15%" align="center" bgcolor="#FFFFFF">赠药批号</td>
                        <td width="10%" align="center" bgcolor="#FFFFFF">月初库存量</td>
                        <td width="10%" align="center" bgcolor="#FFFFFF">本月入库</td>
                        <td width="10%" align="center" bgcolor="#FFFFFF">本月出库</td>
                        <td width="10%" align="center" bgcolor="#FFFFFF">破损数量</td>
                        <td width="10%" align="center" bgcolor="#FFFFFF">实际库存</td>
                    </tr>
                    <?php
...
//                            }
                        ...
                        while ($mxRecord = mysql_fetch_array($mxQuery_ID)) {
                            if ($mxRecord[1] == "0" && $mxRecord[2] == "0" && $mxRecord[3] == "0" && $mxRecord[4] == "0") {
                                ...
                                ?>
                                <td align="left" bgcolor="#FFFFFF"><?php echo $mxRecord[0]."[".$gg."]"; ?></td>
...
<script type="text/javascript">
    function guolv() {
        ...
        var url = 'kfkcpdgl.php?kshrq=' + $('#KaishiRiqi').val() + '&jshrq=' + $('#JiezhiRiqi').val();

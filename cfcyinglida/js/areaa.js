...
var sa=["cbdqs_province","cbdqs_city"];//三个select的name
var opt0 = ["省份","地级市","市、县级市"];//初始值
function _init_areaa(){  //初始化函数
	for(i=0;i<sa.length-1;i++){
	  document.getElementById(sa[i]).onchange=new Function("changea("+(i+1)+")");
	}
	changea(0);
}

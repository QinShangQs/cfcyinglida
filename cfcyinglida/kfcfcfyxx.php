...
?>    
    <div id="content">
      <div id="con">
        <div class="position">
          <a href="kfchkgl.php">出库管理</a>
          > <?php echo $html_title;?>  <a href="cfcywyshbpdf.php?id=<?php echo $shqid;?>">下载</a>
        </div>
      </div>
    </div>
...
?>
              ...
              <tr>
                ...
                <td align="center"><?php echo $Record['gg1'];?></td>
                <td align="center">数量</td>
                <td align="center"><?php if($Record[20]!=""){echo $Record[20];}else {echo "0";}?>盒</td>
              </tr>
              <tr>
  ...
  while($shhrRecord = mysql_fetch_array($shhrQuery_ID)){echo $shhrRecord[0];}?></div>
	<div style="width:400px; float:right; padding-top:50px; padding-bottom:20px;">日期：<?php echo date('Y年m月d日',strtotime($Record[18]));?></div>                   
              ...
              <tr>
                ...
                <td colspan="3" align="center"><?php if($Record[8]>=2){echo ($Record[20]+$Record[21])."盒";}?></td>
              </tr>
              <tr>

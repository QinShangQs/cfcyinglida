...
<div class="main">
	<div class="insmain">
		<div class="thislink">
			当前位置：<a href="shqgl.php">申请管理</a> > <?php echo $html_title;?></a>
		</div>
...
while ( $Record = mysql_fetch_array ( $Query_ID ) ) {
	...
	if ($Record [3] == "拒绝" || $Record [3] == "申诉拒绝") {
		$shqzht = '-1';
		$anzht = '4';
	} else if ($Record [3] == "申诉待审核" || $Record [3] == "申诉审核") {
		$shqzht = '0';
		$anzht = '5';
	} else if ($Record [3] == "入组") {
		$shqzht = '1';
		...
		$shqzht = '0';
		$anzht = '0';
	} else if ($Record [3] == "待办入组") {
		$anzht = '1';
	} else if ($Record [3] == "停止申请") {
		$shqzht = '-1';
		$anzht = '6';
	}
	...
	if ($Record [3] != "出组") {
		...
		echo $Record [3] . " 原因:" . $Record [42] . " 出组日期:" . $Record [41];
	}
	echo "</div>";
	...
	if ($shqzht == "-1") { // 可申诉状态
		if ((($anzht == '4' || ($anzht == '3' && $Record [42] != '死亡')) && (in_array ( 'shqgl_shh', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll')) || $_SESSION ['yhln'] == "admin") { // ||$anzht=='6'
			if ($anzht == '3') {
				if ($_SESSION ['yhln'] == "admin" || $Record [42] != '死亡') {
					?>
        <input type="button" value="重新入组" class="uusub2"
							onclick="javascript:{location.href='shqglxzshqer.php?id=<?php echo $yhid;?>'}" />
        <?php
				} else {
					?>
        ...
        <?php
				...
				?>
        <input type="button" value="申诉" class="uusub2"
							onclick="javascript:{location.href='shhjlshs.php?id=<?php echo $yhid;?>'}" />
        <?php
			} else if ($anzht == '6') {
				?>
        <input type="button" value="申诉" class="uusub2"
		...
		if ($shqzht != "1") { // 非入组状态
			if (($anzht == '0' || $anzht == '5' || $anzht == '1') && (in_array ( 'shqgl_shh', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll')) {
				?>
        <input type="button" value="审核" class="uusub2"
							onclick="javascript:{location.href='shhjl.php?id=<?php echo $yhid;?>'}" />
        <?php
			} else {
				?>
        <input type="button" value="审核" class="uusub2"
        ...
        <?php
			...
			if (in_array ( 'shqgl_shh', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
				?>
        <input type="button" value="社会调查" class="uusub2"
							onclick="javascript:{location.href='xzshhdch.php?id=<?php echo $yhid;?>'}" />
						<input type="button" value="停止申请" class="uusub2"
							onclick="javascript:{location.href='shhjltzh.php?id=<?php echo $yhid;?>'}" />
						<input type="button" value="拒绝" class="uusub2"
							onclick="javascript:{location.href='shhjljj.php?id=<?php echo $yhid;?>'}" />
        <?php
			} else {
				?>
        <input type="button" value="社会调查" disabled="disabled" /> <input
							type="button" value="停止申请" disabled="disabled" /> <input
							type="button" value="拒绝" disabled="disabled" />
        <?php
			}
		}
        ...
        <input type="button" value="修改基本信息" class="uusub2"
							onclick="javascript:{location.href='xgjbxx.php?id=<?php echo $yhid;?>'}" />
        <?php
		}
		if ($shqzht == "1") {
			if (in_array ( 'sfjlgl_xz', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
				?> 
        <input type="button" value="新增随访记录" class="uusub2"
							onclick="javascript:{location.href='xzsfjl.php?id=<?php echo $yhid;?>'}" />
        <?php
			} else {
				?>
        ...
        <?php
			...
			if (in_array ( 'shqgl_zhzh', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
				?>
        <input type="button" value="转诊" class="uusub2"
							onclick="javascript:{location.href='zhzhshqxz.php?id=<?php echo $yhid;?>';}" />
        <?php
			} else {
				?>
        ...
        <?php
			...
			if (in_array ( 'shqgl_chz', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
				?>
        <input type="button" value="办理出组" class="uusub2"
							onclick="javascript:{location.href='blchz.php?id=<?php echo $yhid;?>';}" />
        <?php
			} else {
				?>
		...
		if ($_SESSION ['yhln'] == "admin") {
			?>
                <input type="button" value="修改状态" class="uusub2"
							onclick="javascript:{location.href='xgshqzht.php?id=<?php echo $yhid;?>';}" />

        <?php
			if ($shqzht == "1") {
				?><div class="top">
							特殊情况授权： <input type="button" value="特殊情况授权（无证明）" class="uusub2"
								onclick="javascript:{location.href='tshqkshqwu.php?id=<?php echo $yhid;?>';}" />
							<input type="button" value="特殊情况授权（月中换药）" class="uusub2"
								onclick="javascript:{location.href='tshqkshqwu.php?id=<?php echo $yhid;?>';}" />
							<input type="button" value="特殊情况授权（长期未领药）" class="uusub2"
								onclick="javascript:{location.href='tshqkshqwu.php?id=<?php echo $yhid;?>';}" />
							<input type="button" value="特殊情况授权（代领药）" class="uusub2"
								onclick="javascript:{location.href='tshqkshqwu.php?id=<?php echo $yhid;?>&qk=2';}" />
							<input type="button" value="特殊情况修改入组医院" class="uusub2"
								onclick="javascript:{location.href='tshqkxgrzyy.php?id=<?php echo $yhid;?>';}" />
							<input type="button" value="特殊情况修改赠药数量" class="uusub2"
								onclick="javascript:{location.href='tshqkxgzyshl.php?id=<?php echo $yhid;?>';}" />
						</div>
        <?php
			}
		}
...
echo sprintf ( "%05d", $Record [0] );
	...
	?>
           <tr style="color: #1f4248; font-size: 12px;">
									...
									<td align="center" bgcolor="#FFFFFF" colspan="6"><?php echo $Record[14];?></td>
								</tr>
								<tr style="color: #1f4248; font-size: 12px;">
									<td align="center" bgcolor="#FFFFFF">患者手机：</td>
									<td align="center" bgcolor="#FFFFFF"><?php echo $Record[15];?></td>
									<td align="center" bgcolor="#FFFFFF">第一联系人姓名：</td>
									<td align="center" bgcolor="#FFFFFF"><?php echo $Record[59];?></td>
									<td align="center" bgcolor="#FFFFFF">第一联系人关系：</td>
									<td align="center" bgcolor="#FFFFFF"><?php echo $Record[60];?></td>
									<td align="center" bgcolor="#FFFFFF">第一联系人电话：</td>
									<td align="center" bgcolor="#FFFFFF" align="left"><?php echo $Record[16];?></td>
								</tr>
								<tr style="color: #1f4248; font-size: 12px;">
									<td align="center" bgcolor="#FFFFFF">第二联系人姓名：</td>
									<td align="center" bgcolor="#FFFFFF"><?php echo $Record[61];?></td>
									<td align="center" bgcolor="#FFFFFF">第二联系人关系：</td>
									...
									<td align="center" bgcolor="#FFFFFF" style="text-align: left"
										colspan="3"><?php echo $Record[17];?></td>
								</tr>
								<tr style="color: #1f4248; font-size: 12px;">
								...
								<tr style="color: #1f4248; font-size: 12px; display: none">
       ...
       <?php 
/*
	       * if($Record[30]!=""){?> &nbsp;&nbsp;首次用药日期：<?php echo $Record[30];}<span class="label" style="width: 150px">项目申请信息表日期：</span><?php echo $Record[31];?>
	       * &nbsp;&nbsp;
	       */
	?></td>
								...
								<tr style="color: #1f4248; font-size: 12px;">
									<td align="center" bgcolor="#FFFFFF">初次审核日期：</td>
									<td align="center" bgcolor="#FFFFFF"><?php echo $Record[32];?></td>
									<td align="center" bgcolor="#FFFFFF"><?php if($Record[34]!=""){ echo "正式入组日期：";}?></td>
									<td align="center" bgcolor="#FFFFFF"><?php if($Record[34]!=""){ echo $Record[34];}?></td>
					...
					<fieldset class="top">
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								...
								<td align="center" bgcolor="#FFFFFF">证件号码</td>
								<td align="center" bgcolor="#FFFFFF">与患者关系</td>
	...
	while ( $qshRecord = mysql_fetch_array ( $qshQuery_ID ) ) {
		...
		if ($qshRecord [3] != "") {
			echo "身份证:" . $qshRecord [3];
		} else if ($qshRecord [7] != "") {
			echo "军官证:" . $qshRecord [7];
		}
						...
						<TABLE width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<TBODY>
								<TR style="color: #1f4248; font-weight: bold; height: 30px;">
									...
									<Td align="center" bgcolor="#FFFFFF">说明原因</Td>
								</TR>
<?php
	...
	while ( $shpRecord = mysql_fetch_array ( $shpQuery_ID ) ) {
		...
		if ($shpRecord [1] == 1) {
			...
			echo $shpRecord [4] . "</br>备注：" . $shpRecord [5];
		}
		echo "</PRE></TD></TR>";
	}
	?>
			...
			?> <a href="xzshhdch.php?id=<?php echo $yhid;?>">新增</a><?php }}?></legend>
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								...
								<th width="10%" align="center" bgcolor="#FFFFFF">调查部门</th>
								<th width="10%" align="center" bgcolor="#FFFFFF">联系电话</th>
								<th width="10%" align="center" bgcolor="#FFFFFF">是否属实</th>
								<th width="10%" align="center" bgcolor="#FFFFFF">调查日期</th>
								<th width="10%" align="center" bgcolor="#FFFFFF">调查人</th>
    ...
    <fieldset class="top">
		...
		if ($shqzht == '-1') {
			?>
<div>
							<a href="shhjlshs.php?id=<?php echo $yhid;?>">申诉</a>
						</div>
            <?php
		} else if ($shqzht != '1' && $shqclqq == '1' && $shfshsh == '1') {
			?>
<div>
							<a href="shhjl.php?id=<?php echo $yhid;?>">办理入组</a>
						</div>
            <?php
		}
		?>
        <table width="100%" border="0" cellpadding="5" cellspacing="1"
							bgcolor="#cdcdcd">
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								<th style="width: 40px;" align="center" bgcolor="#FFFFFF">操作</th>
								<th style="width: 80px;" align="center" bgcolor="#FFFFFF">审核人</th>
								<th style="width: 110px;" align="center" bgcolor="#FFFFFF">批准状态
								</th>
								<th style="width: 90px;" align="center" bgcolor="#FFFFFF">审核日期</th>
								<th align="center" bgcolor="#FFFFFF">备注、说明</th>
							</tr>
        <?php
...
if ($shqzht != "-1" || (in_array ( 'blshjbggl_xz', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll')) {
		?><a href="blshjxz.php?id=<?php echo $yhid;?>">新增<?php }?></a>
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								...
								<td align="center" bgcolor="#FFFFFF">事件信息来源</td>
								<td align="center" bgcolor="#FFFFFF">索坦用量及用法</td>
								<td align="center" bgcolor="#FFFFFF">事件描述</td>
								<td align="center" bgcolor="#FFFFFF">CFC填表人</td>
								<td align="center" bgcolor="#FFFFFF">获知的日期</td>
...
if ($shqzht != "-1") {
		...
		if ($hzhlysf == 1 || $hzhyxpgb == 0) {
			if (in_array ( 'yxpgbg_xz', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
				?><a
								href="yxpgbgxz.php?id=<?php echo $yhid; if($hzhyxpgb==0){ echo "&hzhyxpgbg=0";} ?>">新增</a><?php
			} else {
				?><a>新增</a><?php
			}
		}
	...
	?>
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								...
								<th align="center" bgcolor="#FFFFFF">评估类型</th>
								<th align="center" bgcolor="#FFFFFF">录入日期</th>
								<th align="center" bgcolor="#FFFFFF">录入人</th>
	...
	if (! empty ( $hzhyxpgbq )) {
		foreach ( $hzhyxpgbq as $key => $val ) {
			...
			echo '医学条件评估';
			echo "</td><td align=\"center\" bgcolor=\"#FFFFFF\">" . $val ['addtime'] . "</td><td align=\"center\" bgcolor=\"#FFFFFF\">" . $val ['lrr'] . "</td></tr>";
		}
	}
	?>
        </table>
	...
	?></legend>
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								<td align="center" bgcolor="#FFFFFF">操作</td>
								<td align="center" bgcolor="#FFFFFF">寄出日期</td>
								<td align="center" bgcolor="#FFFFFF">运单号</td>
								<td align="center" bgcolor="#FFFFFF">领药药房名称</td>
								<td align="center" bgcolor="#FFFFFF">领药地址</td>
								<td align="center" bgcolor="#FFFFFF">药房联系方式</td>
	...
	while ( $sfshcRecord = mysql_fetch_array ( $sfshcQuery_ID ) ) {
		...
		while ( $sfshcyfRecord = mysql_fetch_array ( $sfshcyfQuery_ID ) ) {
			if ($sfshcyfRecord [4] == $sfshcyfRecord [5]) {
				$sfscyfshengshi = $sfshcyfRecord [4];
			} else {
				$sfscyfshengshi = $sfshcyfRecord [4] . $sfshcyfRecord [5];
			}
	...
	?>
					...
					<fieldset class="top">
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							bgcolor="#cdcdcd">
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								<th align="center" bgcolor="#FFFFFF">领药次数/瓶数</th>
								<th align="center" bgcolor="#FFFFFF">药品规格</th>
								<th align="center" bgcolor="#FFFFFF">交回余药数量</th>
								<th align="center" bgcolor="#FFFFFF">交回空瓶数量</th>
								<th align="center" bgcolor="#FFFFFF">领药人</th>
								<th align="center" bgcolor="#FFFFFF">药师</th>
								<th align="center" bgcolor="#FFFFFF">药房名称</th>
								<th align="center" bgcolor="#FFFFFF">发药日期</th>
							</tr>
        <?php
		...
		?>
            <tr style="color: #1f4248; font-size: 12px;">
								<td align="center" bgcolor="#FFFFFF"><a
									href="cfcyshfyxq.php?id=<?php echo $blshRecord[0];?>"><?php
		...
		if (in_array ( 'shqgl_zhzh', $_SESSION [yhqxxf] ) || $_SESSION [yhshf] == '10' || $_SESSION [yhqxxf] [0] == 'admin_AllowAll') {
			?><a href="zhzhshqxz.php?id=<?php echo $yhid;?>">新增</a><?php }}?></legend>
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr style="color: #1f4248; font-weight: bold; height: 30px;">
								<td align="center" bgcolor="#FFFFFF">操作</td>
								<td style="width: 60px" align="center" bgcolor="#FFFFFF">申请日期</td>
								<td align="center" bgcolor="#FFFFFF">理由</td>
								<td style="width: 40px" align="center" bgcolor="#FFFFFF">状态</td>
								<td style="width: 120px" align="center" bgcolor="#FFFFFF">转出医院</td>
								<td style="width: 120px" align="center" bgcolor="#FFFFFF">转入医院</td>
								<td style="width: 120px" align="center" bgcolor="#FFFFFF">转出药房</td>
								<td style="width: 120px" align="center" bgcolor="#FFFFFF">转入药房</td>
								<td style="width: 60px" align="center" bgcolor="#FFFFFF">经办日期</td>
							</tr>
        <?php

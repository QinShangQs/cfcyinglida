...
$zht = $_POST['Zuofei'];
  ...
  $query="UPDATE `kfrk` SET `ph`='$ph' ,`zhwmch`='$zhwmch',`yxrqzh`='$yxrqzh',`ywmch`='$ywmch',`jpbh`='$jpbh',`shchdwchd`='$shchdwchd',`shyrq`='$shyrq',`bjdw`='$bjdw',`zhczhh`='$zhczhh',`jymd`='$jymd',`bjshl`='$bjshl',`gg`='$gg',`jxxh`='$jxxh',`pjh`='$pjh',`hth`='$hth',`bzhgg`='$bzhgg',`zht`='$zht' WHERE `id` = '$rkid'";

...
?>
    <div class="main">
		<div class="insmain">
			<div class="thislink">当前位置：<a href="yshdfqdgl.php"><?php echo $html_title;?></a> </div>
       ...
       <tr>
        ...
        预估发药日期在<select Style="width:80px" class="grd-white" id="Day" name="Day" onchange="guolv();"></td>
...
$pagenum = ceil($num/$pagesize);
  ...
  while($yshtmRecord = mysql_fetch_array($yshtmQuery_ID)){$yfyshid[]=$yshtmRecord[0];}
...
?>
    <div class="insinsins"><span>&nbsp;&nbsp;预估待发药数：<?php echo $num." ";?>盒(5mg) 当前库存数：<?php echo $kcshshd1-$kcshfy1;?> 盒(5mg)  <?php /*(当前药房id: <?php echo $yshid." ";?>开发期间调用)*/?></span></div>
...
if($shqidzt>0){$shqid=1;$shqidzt=0;}else{$shqid=0;$shqidzt=0;}
//特殊情况发药 结束
            ...
            <td width="8%" align="center" bgcolor="#FFFFFF"><?php
                ...
                if($lynum=="0"){
                    if($hzhygshcyyshj!=""||$shqid>0){
                        ...
                        if(($nowdate_d>=$hzhygshcyyshj_d&&$Days>=0&&$Days<=30)||$shqid>0){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}else{echo "发药";}
                    }
                    else if('1'=='1'){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}
                    else{echo "发药";}
                }
                else if($lynum>"0"){
                    ...
                    if($ygxcfyrqshj!=""||$shqid>0){
                        ...
                        if(($Days>=0&&$Days<=30)||$shqid>0){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}else{echo "发药";}
                    }
                    else if('1'=='1'){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}
                    else {echo "发药";}
                }
...
if($shqidzt>0){$shqidchq=1;$shqidzt=0;}else{$shqidchq=0;$shqidzt=0;}
//特殊情况发药 结束
            ...
            <td align="center" bgcolor="#FFFFFF"><?php
                ...
                if($lynum=="0"){
                    if($hzhygshcyyshj!=""||$shqidchq>0){
                        ...
                        $hzhygshcyyshj_d=mktime(0,0,0,$hzhygshcyyshj_List[1],$hzhygshcyyshj_List[2],$hzhygshcyyshj_List[0]);
                        $Days=($nowdate_d-$hzhygshcyyshj_d)/3600/24;
                        if(($nowdate_d>=$hzhygshcyyshj_d&&$Days>=0&&$Days<=30)||$shqidchq>0){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}else{echo "发药";}
                    }else{echo "发药";}
                } /*
else if($lynum=="0"&&$hzhjzhlx=="部分"){
  if($hzhshcyyshj!=""){
...
if($Days>=-7&&$Days<=23){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}else{echo "发药";}
                    ...
                    if($ygxcfyrqshj!=""||$shqidchq>0){
                        ...
                        $ygxcfyshj_d=mktime(0,0,0,$ygxcfyshj_List[1],$ygxcfyshj_List[2],$ygxcfyshj_List[0]);
                        $Days=($nowdate_d-$ygxcfyshj_d)/3600/24;
                        if(($Days>=0&&$Days<=30)||$shqidchq>0){echo "<a href=\"yshfy.php?id=".$Record[0]."\">发药</a>";}else{echo "发药";}
                    }
                    else {echo "发药";}
                }
                ?></td>

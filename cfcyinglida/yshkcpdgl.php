...
<div class="main">
	<div class="insmain">
		<div class="thislink">
			当前位置：<a href="yshkcpdgl.php">库存盘点</a>
		</div>
		<div class="inwrap flt top">
			<div class="title w977 flt">
				<strong>库存盘点</strong><span>
				<?php
				##读取公告盘点
				$xtggxxsql = "select id,ggnr from `xtggxx` where `ggzht`='1' and `tshgn`='1' order by id desc limit 1";				
				$xtggxxQuery_ID = mysql_query ( $xtggxxsql );
				while ( $xtggxxRecord = mysql_fetch_array ( $xtggxxQuery_ID ) ) {
					$xtggxx = "1"; // 读取数据库，特殊情况，系统管理设置可以盘点
					$ggnr = $xtggxxRecord[1];//1是统计当月，0为统计上月
				}
			...
			<div class="incontact w955 flt">
				...
				<div class="insinsins">
					<span><input class="grd-white" type="text" id="KaishiRiqi"
						name="KaishiRiqi" readonly="readonly" placeholder="请输入开始日期"
						size="12" value="" /> - <input class="grd-white" type="text"
						id="JiezhiRiqi" name="JiezhiRiqi" readonly="readonly"
						placeholder="请输入结束日期" size="12" value="" /> <input type="button"
						value="按盘点日期过滤" onclick="guolv();" class="uusub" /></span>
				</div>
				<div class="forB">

                    <table width="100%" border="0" cellpadding="5"
						cellspacing="1" bgcolor="#cdcdcd">
